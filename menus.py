...
# Create dummy user
User1 = User(name="admin", email="sharathgrao@gmail.com")
session.add(User1)
session.commit()

# Menu for Raju Ka Kitchen
restaurant1 = Restaurant(name="Mommys Kitchen", user_id="1")
...
menuItem1 = MenuItem(name="Masala Dosa",
                     ...
                     price="$1.99", restaurant=restaurant1, user_id=1)
...
menuItem3 = MenuItem(name="Chicken Biryani",
                     description="Chicken Rice dish with veggies and chutney"
